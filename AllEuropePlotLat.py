...
#filepath = '../data/0.25_gen_and_lat_no_sectors_no_transmission.csv'
#filepath = '../data/0.25_gen_and_lat_no_sectors_yes_transmission.csv'
#filepath = '../data/0.25_gen_and_lat_yes_sectors_no_transmission.csv'
filepath = '../data/0.25_gen_and_lat_yes_sectors_yes_transmission.csv'
...
fig.savefig('../figures/Adamnew'+ sectors + 'sec' + transmission + 'trans.png',format='png',bbox_inches='tight')  
