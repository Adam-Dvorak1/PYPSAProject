...
def retrieve_generators_choice(filepath):
    ...
    This currently uses frame.append. Pandas says they will remove it, and thus we wouuld need to use the pandas.concat method instead'''
...
if __name__ == "__main__":
    ...
    run = "18Jan2023_ReviewerNewCosts"
